								...
								<tbody>
								  <c:forEach var="stu" items="${studentList}">
									...
									<tr>
										...
										<td><a
											href="studentInfo/${stu.sid}"
											class='btn btn-primary btn-xs mrg'style="margin-left: 2px;font-size: 20px" data-placement='top'
											data-toggle='tooltip' data-original-title='View'><i
												class='fa fa-eye'></i></a>
												
												<a
											href="admission_approval/${stu.sid }"
											class='btn btn-success btn-xs mrg'style="margin-left: 2px;font-size: 20px" data-placement='top'
											data-toggle='tooltip' data-original-title='Accept'><i
												class='fa fa-check-square-o'></i></a><a
											href="studentregdis/${stu.sid }"
											onclick="return confirm('Do You Want Reject This ?')"
											class="btn btn-danger btn-xs mrg" style="margin-left: 2px;font-size: 20px" data-placement="top"
											data-toggle="tooltip" data-original-title="Reject"><i
